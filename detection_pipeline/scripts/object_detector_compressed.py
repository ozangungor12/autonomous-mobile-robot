...
class ObjectDetector():
    ...
    def __init__(self):
        rospy.Subscriber("raw_image/compressed", CompressedImage, self.callback)
        self.img_publisher = rospy.Publisher("detection/compressed", CompressedImage, queue_size=1)
